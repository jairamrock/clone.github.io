 ...
 * the License.
 */
/* Web Font Loader v1.6.26 - (c) Adobe Systems, Google. License: Apache 2.0 */(function(){function aa(a,b,c)
    ...
    var q=Date.now||function()
    {
        ...
        }function u(a,b,c)
        {
            ...
            a.insertBefore(c,a.lastChild)}function v(a){a.parentNode&&a.parentNode.removeChild(a)
            }
function w(a,b,c)
{
    b=b||[];
    ...
    }b=[];for(e=0;e<d.length;e+=1)
    {
        ...
        if(d[e]===c[g]
            ...
            f||b.push(d[e])}a.className=b.join(" ").replace(/\s+/g," ").replace(/^\s+|\s+$/,"")}function y(a,b)
            {
...
function A(a,b,c)
{
    ...
    b=t(a,"link",
    {
        rel:"stylesheet",href:b,media:"all"
    }
    );
    ...
    b.onerror=function()
    {
        e=!0;g=Error("Stylesheet failed to load");
        d()
    }):
    setTimeout(function(){e=!0;d()},0);u(a,"head",b)
}
function B(a,b,c,d)
...
if(e)
{
    ...
    {
        g||this.readyState&&"loaded"!=this.readyState&&"complete"!=this.readyState||(g=!0,c&&c(null),
...
function G(a)
{this.a=a||"-"}G.prototype.c=function(a)
{
    for(var b=[],c=0;
        c<arguments.length;
        c++
        ...
        function H(a,b){this.c=a;this.f=4;
            this.a="n";
        ...
        function I(a)
        {
            var b="normal";"o"===a.a?b="oblique":"i"===a.a&&(b="italic");
            return b
        }
function ga(a)
{
    var b=4,c="n",d=null;
    a&&((d=a.match(/(normal|oblique|italic)/i))
    &&d[1]&&(c=d[1].substr(0,1).toLowerCase()),
    (
    ...
    {
        this.c=a;
        this.f=a.m.document.documentElement;this.h=b;
        this.a=new G("-");
        this.j=!1!==b.events;
        this.g=!1!==b.classes
    }
    function ia(a)
    {
        ...
        L(a,"loading")}function M(a)
        {
            if(a.g)
            {
                var b=y(a.f,a.a.c("wf","active")),
                c=[],d=[a.a.c("wf","loading")
            ];
            ...
            function P(a)
            {
                ...
                function Q(a,b,c,d,e,f)
                {
                    ...
                    this.h=f||void 0}Q.prototype.start=function()
                    {
                        ...
                        {function k()
                            {
                                q()-c>=b.f?e():a.fonts.load(fa(b.a),b.h).then(
                                    function(a)
                                    {
                                        ...
                                        function R(a,b,c,d,e,f,g)
                                        {
                                            ...
                                            this.w=e||3E3;
                                            this.u=f||null;
                                            this.o=this.j=this.h=this.g=null;this.g=new N(this.c,this.s);
                                            this.h=new N(this.c,this.s);
                                            this.j=new N(this.c,this.s);
                                            this.o=new N(this.c,this.s);
                                            a=new H(this.a.c+",serif",K(this.a));a=P(a);this.g.a.style.cssText=a;a=new H(this.a.c+",sans-serif",K(this.a));a=P(a);
                                            this.h.a.style.cssText=a;a=new H("serif",K(this.a));
                                            a=P(a);this.j.a.style.cssText=a;a=new H("sans-serif",K(this.a));
                                            a=P(a);this.o.a.style.cssText=a;O(this.g);O(this.h);
                                            O(this.j);O(this.o)}
                                            var S={
                                                D:"serif",C:"sans-serif"},T=null;
                                                function U()
                                                {
                                                    if(null===T)
                                                    {
...
function la(a)
{
    ...
    }function V(a,b)
    {
        ...
        function W(a,b,c)
        {
            ...
            {
                var b=this.a;b.g&&w(b.f,[b.a.c("wf",a.c,K(a).toString(),"active")],
                [b.a.c("wf",a.c,K(a).toString(),"loading"),b.a.c("wf",a.c,K(a).toString(),"inactive"
                )]);
                L(b,"fontactive",a);this.o=!0;oa(this)
            };
...
function oa(a)
{
    0==--a.f&&a.j&&(a.o?(a=a.a,a.g&&w(a.f,[a.a.c("wf","active")],
...
function pa(a)
{
    ...
    this.a=new ja;
    this.h=0;
    this.f=this.g=!0}pa.prototype.load=function(a)
    {
    ...
    (a.f||a.g)&&setTimeout(function()
    {
        ...
        else
        {
            ...
            for(h=0;h<c.length;h++)
            {
                ...
                m.push(r)}for(h=0;h<m.length;h++)m[h].start()}
        }
                ,0)}function qa(a,b,c)
                {
                    var d=[],e=c.timeout;
...
sa.prototype.load=function(a)
{
    function b()
    {
        ...
        if(d)
        {
            var f=c.c.m;
            B(this.c,ta(c,d,e),
            function(e){e?a([]):(f["__MonotypeConfiguration__"+d]=function()
            {
                return c.a},b())
            }
...
ua.prototype.load=function(a)
{
    ...
    if(d=e[b].split(":"),d[1])
    for(var h=d[1].split(","),m=0;
    m<h.length;m+=1)k.push(new H(d[0],h[m]));
    else k.push(new H(d[0]));F(g,function(){a(k,f)})};
    function va(a,b,c){a?this.c=a:this.c=b+wa;this.a=[];
        this.f=[];
        this.g=c||""}var wa="//fonts.googleapis.com/css";
        function xa(a,b)
        {
...
function ya(a)
{
    ...
    0<a.g.length&&(b+="&text="+encodeURIComponent(a.g));return b
};
function za(a)
{
...
var Aa=
{
    latin:"BESbswy","latin-ext":"\u00e7\u00f6\u00fc\u011f\u015f",cyrillic:"\u0439\u044f\u0416",greek:"\u03b1\u03b2\u03a3",khmer:"\u1780\u1781\u1782",Hanuman:"\u1780\u1781\u1782"},
    Ba=
    {
        thin:"1",
        extralight:"2",
...
function Ea(a)
{
    ...
    {
        var d=a.f[c].split(":"),e=d[0].replace(/\+/g," "),
        f=["n4"];if(2<=d.length)
        {
            var g;
            var k=d[1];
            ...
            for(var k=k.split(","),h=k.length,m=0;m<h;m++)
            {
                ...
                if(l.match(/^[\w-]+$/))
                {
                    ...
                    else
                    {
                        ...
                        var r=Ba[n],n=r?r:isNaN(n)?"4":n.substr(0,1);
                        l=[l,n].join("")
                    }
                }
                else l="";
                l&&g.push(l)}0<g.length&&(f=g);
                3==d.length&&(d=d[2],g=[],d=d?d.split(","):
g,0<d.length&&(d=Aa[d[0]])&&(a.c[e]=d))}a.c[e]||(d=Aa[e])&&(a.c[e]=d);
...
Ha.prototype.load=function(a)
{
    ...
    b?B(this.c,(this.a.api||"https://use.typekit.net")+"/"+b+".js",function(b)
    {
        ...
        (c.Typekit&&c.Typekit.config&&c.Typekit.config.fn)
        {
